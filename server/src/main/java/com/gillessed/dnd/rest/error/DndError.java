...
public interface DndError {
    ...
    enum Type {
        ...
        WIKI_PAGE_NOT_FOUND("The page you were looking for was not found.", WIKI),
        ERROR_BUILDING_PAGE("The page file could not be parsed correctly. Please try again later.", WIKI);
